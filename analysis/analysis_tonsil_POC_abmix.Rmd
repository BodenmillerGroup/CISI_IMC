...
compression. This dictionary came from the run with the parameters: k=4, d=10 and 
...
```{r plot_images_simulated_vs_decomposed, fig.asp=0.25, fig.width=18, fig.align="center", fig.keep=c(3, 6, 9, 12, 15, 18, 21, 24), results="asis"}
