...
U_path = Path(os.path.join(data_path,
                                'analysis/Tonsil_th152/training/subset/proof_of_concept_fixed_A/gene_modules.csv'))
A_path = Path(os.path.join(data_path,
                                'analysis/Tonsil_th152/training/subset/proof_of_concept_fixed_A/version_1.txt'))

## Specify output path
out_path_training = Path(os.path.join(data_path, 'analysis/Tonsil_th152/training/subset/proof_of_concept_fixed_A/training'))
out_path_experiment = Path(os.path.join(data_path, 'analysis/Tonsil_th152/training/subset/proof_of_concept_fixed_A/experiment'))
...
decompression_file = open(os.path.join(data_path,
                                'analysis/Tonsil_th152/training/subset/proof_of_concept_fixed_A/decomposition_simulation_results.txt'), 'w')
...
for k in list(decompressed_anndata.layers.keys()):
    ...
    decompressed_anndata.write(os.path.join(path, 'X_decomposed.h5ad'))
