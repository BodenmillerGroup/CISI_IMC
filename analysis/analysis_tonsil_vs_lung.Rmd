...
s_protein_3.plot <-  plot_protein_scatterplot(X.cor %>%
                                                dplyr::filter(dataset=="lung_lung")) +
  theme_cowplot(thesis_title.fontsize)
s_protein_4.plot <-  plot_protein_scatterplot(X.cor %>%
...
# Save s_protein
s_protein.grid <- plot_grid(s_protein_1.plot, s_protein_2.plot, s_protein_3.plot,
                            s_protein_4.plot, ncol=1, labels="AUTO", align="h", axis="l")
# Save d_neighbours_L
save_plot(file.path(plot.folder, "s_protein.pdf"),
          s_protein.grid, base_width=4.77)
