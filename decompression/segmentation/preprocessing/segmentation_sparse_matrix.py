...
if __name__ == '__main__':
	...
	parser.add_argument('--tissues', help='Comma-separated list of tissue numbers to include', default='5')
	parser.add_argument('--mask-file', help='Mask file (or prefix), eg ExpandedNuclei_* or DAPI.tiff', default='mask.tiff')
